...
//    private String IMAGE_URL;
    ...
    public String upload(@RequestParam("uploadFile") MultipartFile uploadFile, HttpServletResponse response)
        ...
        for (String type : IMAGE_TYPE) {
        	//getOriginalFilename获取上传的原始文件名称
        ...
        // 生成图片的绝对引用地址
        String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, this.propertiesService.IMAGE_PATH),
                "\\", "/");
        fileUploadResult.setUrl(this.propertiesService.IMAGE_URL + picUrl);
        ...
        //将java对象序列化为json字符串
        return PropertiesService.MAPPER.writeValueAsString(fileUploadResult);
    }

    //E:\\1110\\taotao-upload\\images\\2015\\11\\13\\20151113111111111.jpg
    private String getFilePath(String sourceFileName) {
        String baseFolder = this.propertiesService.IMAGE_PATH + File.separator + "images";
